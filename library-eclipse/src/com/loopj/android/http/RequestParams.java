...
public class RequestParams implements Serializable {
    ...
    protected final ConcurrentHashMap<String, List<FileWrapper>> fileParams = new ConcurrentHashMap<String, List<FileWrapper>>();
    ...
    public void put(String key, File file, String contentType, String customFileName) throws FileNotFoundException {
        ...
        if (key != null) {
            ...
            fileList.add(new FileWrapper(file, contentType, customFileName));
        }
    }
    ...
    public String toString() {
        ...
        for(Entry<String, List<FileWrapper>> entry : fileParams.entrySet()) {
